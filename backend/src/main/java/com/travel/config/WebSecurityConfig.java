...
import com.travel.security.AuthEntryPointJwt;
import com.travel.security.AuthTokenFilter;
import com.travel.service.UserDetailsServiceImpl;
        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            ...
            .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))            .authorizeHttpRequests(auth -> 
                auth.requestMatchers("/api/auth/**").permitAll()
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/comments/tour/**").permitAll()
